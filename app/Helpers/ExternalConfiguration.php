...
class ExternalConfiguration
{
        ...
        function __construct()
        {
                ...
                $this->apiKeyID = config('services.cybersource.apikey_id');
                $this->secretKey = config('services.cybersource.secret_key');
                $this->keyAlias = config('services.cybersource.key_alias');
                $this->keyPass = config('services.cybersource.key_pass');
                $this->keyFilename = config('services.cybersource.key_file_name');
                $this->keyDirectory = "Resources/";
                $this->runEnv = config('services.cybersource.run_env');
