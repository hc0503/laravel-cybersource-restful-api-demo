...
<head>
    <title>{{ __('global.register.title') }} - {{ config('app.name') }}</title>
    ...
    <div class="authentication-wrapper authentication-3">
        ...
        <div class="d-flex col-lg-4 align-items-center bg-white p-5">
            ...
            <div class="w-100">
                ...
                <h4 class="text-center text-lighter font-weight-normal mt-5 mb-0">{{ __('global.register.formDescription') }}</h4>

                <!-- Form -->
                <form class="my-5" method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="form-group">
                        <label class="form-label" for="name">{{ __('global.register.yourName') }}</label>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="email">{{ __('global.register.yourEmail') }}</label>
                    ...
                    <button type="submit" class="btn btn-primary btn-block mt-4">{{ __('global.login.signUp') }}</button>
                    <div class="text-light small mt-4">
                        {{ __('global.register.agreeTerms') }}
                        <a href="javascript:void(0)">{{ __('global.register.termsAndPolicy') }}</a>. {{ __('global.register.willSendEmail') }}
                    </div>
                </form>
                <!-- / Form -->

                <div class="text-center text-muted">
                    {{ __('global.register.haveAccount') }} <a href="{{ route('login') }}">{{ __('global.login.signIn') }}</a>
                </div>
