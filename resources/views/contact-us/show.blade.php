...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<form id="form" method="POST" action="{{ route('portal.contactus.update', $contactUs->guid ?? 0) }}">
						
						@csrf
						
						<div class="form-group">
							<textarea id="content" name="content">{{ $contactUs->content ?? '' }}</textarea>
						</div>

						@if (auth()->user()->hasRole('SuperAdmin') || auth()->user()->hasPermissionTo('editcontactus'))
