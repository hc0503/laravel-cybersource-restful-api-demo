...
<nav class="layout-footer footer bg-footer-theme">
	<div class="container-fluid d-flex flex-wrap justify-content-between text-center container-p-x pb-3">
		...
		<div>
			...
			<a href="{{ route('contact-us') }}" class="footer-link pt-3 ml-4">{{ __('global.contactUs.title') }}</a>
			<a href="javascript:void(0)" class="footer-link pt-3 ml-4">{{ __('global.termsAndConditions.title') }}</a>
			<a href="javascript:void(0)" class="footer-link pt-3 ml-4">{{ __('global.privacyPolicy.title') }}</a>
