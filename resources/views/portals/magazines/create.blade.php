			...
			<div class="card">
                ...
                <form id="form" method="POST" action="{{ route('portal.magazines.store') }}" enctype="multipart/form-data">
							...
							<div class="col-md-8 sm-12">
								...
								<div class="form-group @error('frequency_id') is-invalid @enderror">
									...
									<select id="frequency" name="frequency_id" class="form-control" style="width: 100%">
										...
										<option value="{{ $frequency->id }}" {{ old('frequency_id') == $frequency->id ? 'selected' : '' }}>{{ $frequency->name }}</option>
										@endforeach
									</select>
									@error('frequency_id')
										<span class="invalid-feedback" role="alert" style="display: block !important;">
						...
						<div class="form-group">
							...
							<input id="publisher_website" class="form-control @error('publisher_website') is-invalid @enderror" name="publisher_website" value="{{ old('publisher_website') }}">
						...
						<div class="row">
							...
							<div class="form-group col-md-2 col-sm-12">
								...
								<div class="input-group">
									...
									<input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" step="0.01" min="0" max="9999999999">
								</div>
								@error('price')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
