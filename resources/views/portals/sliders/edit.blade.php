	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
                <!-- Form -->
                <form id="form" method="POST" action="{{ route('portal.sliders.update', $slider->guid) }}" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="media align-items-center col-md-4 col-sm-12">
								<img src="{{ asset('storage') . $slider->image }}" alt="{{ $slider->title }}" class="d-block ui-w-140" id="previewImage">
							...
							<div class="col-md-8 col-sm-12">
								<div class="form-group">
									...
									<input id="title" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $slider->title }}" autofocus>
									@error('title')
						...
						<div class="row">
							...
							<div class="form-group col-md-10 col-sm-12">
								...
								<input id="url" class="form-control @error('url') is-invalid @enderror" name="url" value="{{ $slider->url }}">
								@error('url')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
